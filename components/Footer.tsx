...
export default function Footer() {
  return (
    <div className="px-4 pb-6 pt-4 sm:px-6 lg:px-10">
      <footer className="mx-auto max-w-7xl rounded-[28px] border border-ink-900/10 bg-gradient-to-br from-[#FDF6EC] via-[#F3FAF7] to-[#E9F5FB] px-8 pb-8 pt-14 sm:px-12">
